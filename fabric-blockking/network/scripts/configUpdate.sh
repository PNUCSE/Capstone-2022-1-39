...
fetchChannelConfig() {
  ...
  set -x
  peer channel fetch config config_block.pb -o orderer.14.49.119.248:7050 --ordererTLSHostnameOverride orderer.14.49.119.248 -c $CHANNEL --tls --cafile "$ORDERER_CA"
  { set +x; } 2>/dev/null
